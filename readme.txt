...
**[Download now!](https://foliovision.com/wordpress/plugins/fv-testimonials)**

[Support](https://foliovision.com/wordpress/plugins/fv-testimonials) |
[Installation](https://foliovision.com/wordpress/plugins/fv-testimonials/installation) |
[Usage](https://foliovision.com/wordpress/plugins/fv-testimonials/user-guide) | 
[Guide](https://foliovision.com/wordpress/plugins/fv-testimonials/management-guide)


== Installation ==

   1. Download the plugin
   2. Unpack the contents (directory named fv-testimonials)
   3. Upload the directory with your favourite FTP client to your Wordpress plugins directory (usually found "root of domain"/wp-content/plugins)
   4. Go to Wordpress plugins management and activate the plugin
...
For more detailed options for shortcode refer to our manual at https://foliovision.com/wordpress/plugins/fv-testimonials/user-guide
...
= 1.13 =
* Fixes to make work testimonials with featured images and legacy testimonials images
